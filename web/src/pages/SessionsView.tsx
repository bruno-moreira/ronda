  ...
  return (
    <div className="space-y-6">
      <div className="bg-slate-900 border border-slate-800 rounded-2xl p-6 shadow-xl flex justify-between items-center">
        <div>
          <h2 className="text-xl font-bold text-slate-100">Monitoramento de Rondas em Tempo Real</h2>
      ...
      {isLoading ? (
        ...
        <div className="bg-slate-900/50 border border-slate-800/80 rounded-2xl p-12 text-center text-slate-400">
          ...
          <h3 className="text-lg font-semibold text-slate-200">Nenhuma ronda iniciada ainda</h3>
          ...
          <div className="bg-slate-900 border border-slate-800 rounded-2xl p-6 w-full max-w-2xl shadow-2xl space-y-4">
            <div className="flex items-center justify-between border-b border-slate-800 pb-3">
              <div>
                ...
                <p className="text-xs text-slate-400">Rondante: {sessionDetails?.userNome || 'Vigilante'}</p>
              </div>
              <button
            ...
            {isLoadingDetails ? (
              ...
              <p className="text-slate-400 text-center py-6">Nenhum log registrado para esta sessão ainda.</p>
            ) : (
